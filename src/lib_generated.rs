...
pub unsafe fn port_ip_add(ip: *const AddrCidr) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::port_ip_add(ip as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn port_ip_remove(ip: *const AddrIp) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::port_ip_remove(ip as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn port_gateway_set(ip: *const AddrIp) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::port_gateway_set(ip as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn port_route_remove(cidr: *const AddrIp) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::port_route_remove(cidr as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_set_opt_flag(fd: Fd, sockopt: SockOption, flag: Bool) -> Result<(), Errno> {
    let ret =
        wasix_snapshot_preview1::sock_set_opt_flag(fd as i32, sockopt.0 as i32, flag.0 as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_get_opt_flag(fd: Fd, sockopt: SockOption) -> Result<Bool, Errno> {
    ...
    let ret = wasix_snapshot_preview1::sock_get_opt_flag(
        fd as i32,
        sockopt.0 as i32,
        rp0.as_mut_ptr() as i64,
    );
...
pub unsafe fn sock_set_opt_time(
    ...
    let ret =
        wasix_snapshot_preview1::sock_set_opt_time(fd as i32, sockopt.0 as i32, timeout as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_get_opt_time(fd: Fd, sockopt: SockOption) -> Result<OptionTimestamp, Errno> {
    ...
    let ret = wasix_snapshot_preview1::sock_get_opt_time(
        fd as i32,
        sockopt.0 as i32,
        rp0.as_mut_ptr() as i64,
    );
...
pub unsafe fn sock_set_opt_size(fd: Fd, sockopt: SockOption, size: Filesize) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::sock_set_opt_size(fd as i32, sockopt.0 as i32, size as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_get_opt_size(fd: Fd, sockopt: SockOption) -> Result<Filesize, Errno> {
    let mut rp0 = MaybeUninit::<Filesize>::uninit();
    let ret = wasix_snapshot_preview1::sock_get_opt_size(
        fd as i32,
        sockopt.0 as i32,
        rp0.as_mut_ptr() as i64,
    );
...
pub unsafe fn sock_bind(fd: Fd, addr: *const AddrPort) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::sock_bind(fd as i32, addr as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_connect(fd: Fd, addr: *const AddrPort) -> Result<(), Errno> {
    let ret = wasix_snapshot_preview1::sock_connect(fd as i32, addr as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_send_file(
    ...
    let mut rp0 = MaybeUninit::<Filesize>::uninit();
    let ret = wasix_snapshot_preview1::sock_send_file(
        out_fd as i32,
        in_fd as i32,
        offset as i64,
        count as i64,
...
pub mod wasix_snapshot_preview1 {
    ...
    extern "C" {
        ...
        /// Read from a file descriptor, without using and updating the file descriptor's offset.
        /// Note: This is similar to `preadv` in POSIX.
        pub fn fd_pread(arg0: i32, arg1: i32, arg2: i32, arg3: i64, arg4: i64) -> i32;
        /// Return a description of the given preopened file descriptor.
        ...
        /// Write to a file descriptor, without using and updating the file descriptor's offset.
        /// Note: This is similar to `pwritev` in POSIX.
        pub fn fd_pwrite(arg0: i32, arg1: i32, arg2: i32, arg3: i64, arg4: i64) -> i32;
        /// Read from a file descriptor.
        /// Note: This is similar to `readv` in POSIX.
        pub fn fd_read(arg0: i32, arg1: i32, arg2: i32, arg3: i64) -> i32;
        /// Read directory entries from a directory.
        /// When successful, the contents of the output buffer consist of a sequence of
        /// directory entries. Each directory entry consists of a `dirent` object,
        /// followed by `dirent::d_namlen` bytes holding the name of the directory
        ...
        /// read buffer size in case it's too small to fit a single large directory
        /// entry, or skip the oversized directory entry.
        pub fn fd_readdir(arg0: i32, arg1: i32, arg2: i32, arg3: i64, arg4: i64) -> i32;
        /// Atomically replace a file descriptor by renumbering another file descriptor.
        /// Due to the strong focus on thread safety, this environment does not provide
        /// a mechanism to duplicate or renumber a file descriptor to an arbitrary
        /// number, like `dup2()`. This would be prone to race conditions, as an actual
        ...
        /// Write to a file descriptor.
        /// Note: This is similar to `writev` in POSIX.
        pub fn fd_write(arg0: i32, arg1: i32, arg2: i32, arg3: i64) -> i32;
        /// Opens a pipe with two file handles
        ///
        /// Pipes are bidirectional
        ...
        /// Return the attributes of a file or directory.
        /// Note: This is similar to `stat` in POSIX.
        pub fn path_filestat_get(arg0: i32, arg1: i32, arg2: i32, arg3: i32, arg4: i64) -> i32;
        /// Adjust the timestamps of a file or directory.
        /// Note: This is similar to `utimensat` in POSIX.
        ...
        /// Concurrently poll for the occurrence of a set of events.
        pub fn poll_oneoff(arg0: i32, arg1: i32, arg2: i32, arg3: i64) -> i32;
        /// Terminate the process normally. An exit code of 0 indicates successful
        /// termination of the program. The meanings of other values is dependent on
        /// the environment.
        ...
        /// The function referenced by the fork call must be
        /// exported by the web assembly process.
        pub fn thread_spawn(arg0: i32, arg1: i32, arg2: i64, arg3: i32, arg4: i64) -> i32;
        /// Sends the current thread to sleep for a period of time
        ...
        /// Polls for any outstanding events from a particular
        /// bus process by its handle
        pub fn bus_poll(arg0: i32, arg1: i64, arg2: i32, arg3: i32, arg4: i64) -> i32;
        /// Receives the next event data from the bus
        ...
        /// Connects to a websocket at a particular network URL
        pub fn ws_connect(arg0: i32, arg1: i32, arg2: i64) -> i32;
        /// Makes a HTTP request to a remote web resource and
        /// returns a socket handles that are used to send and receive data
        pub fn http_request(
            arg0: i32,
        ...
        /// Note: This is similar to `send` in POSIX, though it also supports writing
        /// the data from multiple buffers in the manner of `writev`.
        pub fn sock_send(arg0: i32, arg1: i32, arg2: i32, arg3: i32, arg4: i64) -> i32;
        /// Send a message on a socket to a specific address.
        /// Note: This is similar to `sendto` in POSIX, though it also supports writing
        /// the data from multiple buffers in the manner of `writev`.
        pub fn sock_send_to(
        ...
        /// IPv4 and/or IPv6 addresses. Each address entry consists of a addr_t object.
        /// This function fills the output buffer as much as possible.
        pub fn resolve(arg0: i32, arg1: i32, arg2: i32, arg3: i32, arg4: i32, arg5: i64) -> i32;
    }
}
