...
pub unsafe fn sock_accept_ready_poll(fd: Fd, waker: Waker) -> Result<Size, Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = wasix_32v1::sock_accept_ready_poll(fd as i32, waker as i64, rp0.as_mut_ptr() as i32);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i32 as *const Size)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_recv_ready_poll(fd: Fd, waker: Waker) -> Result<Size, Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = wasix_32v1::sock_recv_ready_poll(fd as i32, waker as i64, rp0.as_mut_ptr() as i32);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i32 as *const Size)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_send_ready_poll(fd: Fd, waker: Waker) -> Result<Size, Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = wasix_32v1::sock_send_ready_poll(fd as i32, waker as i64, rp0.as_mut_ptr() as i32);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i32 as *const Size)),
        _ => Err(Errno(ret as u16)),
    }
...
pub mod wasix_32v1 {
    ...
    extern "C" {
        ...
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
        pub fn sock_accept_ready_poll(arg0: i32, arg1: i64, arg2: i32) -> i32;
        /// Receive a message and its peer address from a socket.
        ///
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
        ...
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
        pub fn sock_recv_ready_poll(arg0: i32, arg1: i64, arg2: i32) -> i32;
        /// Send a message on a socket.
        ///
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
        ...
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
        pub fn sock_send_ready_poll(arg0: i32, arg1: i64, arg2: i32) -> i32;
        /// Send a message on a socket to a specific address.
        ///
        /// If this function would block it returns Errno::Pending instead
        /// and invokes the waker in the future.
