...
pub unsafe fn args_get(argv: *mut *mut u8, argv_buf: *mut u8) -> Result<(), Errno> {
    let ret = wasix_64v1::args_get(argv as i64, argv_buf as i64);
    match ret {
        0 => Ok(()),
...
pub unsafe fn args_sizes_get() -> Result<(Size, Size), Errno> {
    ...
    let ret = wasix_64v1::args_sizes_get(rp0.as_mut_ptr() as i64, rp1.as_mut_ptr() as i64);
    match ret {
        0 => Ok((
            core::ptr::read(rp0.as_mut_ptr() as i64 as *const Size),
            core::ptr::read(rp1.as_mut_ptr() as i64 as *const Size),
        )),
        _ => Err(Errno(ret as u16)),
    }
}
...
pub unsafe fn environ_get(environ: *mut *mut u8, environ_buf: *mut u8) -> Result<(), Errno> {
    let ret = wasix_64v1::environ_get(environ as i64, environ_buf as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn environ_sizes_get() -> Result<(Size, Size), Errno> {
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let mut rp1 = MaybeUninit::<Size>::uninit();
    let ret = wasix_64v1::environ_sizes_get(rp0.as_mut_ptr() as i64, rp1.as_mut_ptr() as i64);
    match ret {
        0 => Ok((
            core::ptr::read(rp0.as_mut_ptr() as i64 as *const Size),
            core::ptr::read(rp1.as_mut_ptr() as i64 as *const Size),
...
pub unsafe fn clock_res_get(id: Clockid) -> Result<Timestamp, Errno> {
    ...
    let ret = wasix_64v1::clock_res_get(id.0 as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn clock_time_get(id: Clockid, precision: Timestamp) -> Result<Timestamp, Errno> {
    let mut rp0 = MaybeUninit::<Timestamp>::uninit();
    let ret = wasix_64v1::clock_time_get(id.0 as i32, precision as i64, rp0.as_mut_ptr() as i64);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i64 as *const Timestamp)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn clock_time_set(id: Clockid, timestamp: Timestamp) -> Result<(), Errno> {
    let ret = wasix_64v1::clock_time_set(id.0 as i32, timestamp as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_advise(
    ...
    let ret = wasix_64v1::fd_advise(fd as i32, offset as i64, len as i64, advice.0 as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_allocate(fd: Fd, offset: Filesize, len: Filesize) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_allocate(fd as i32, offset as i64, len as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_close(fd: Fd) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_close(fd as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_datasync(fd: Fd) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_datasync(fd as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_fdstat_get(fd: Fd) -> Result<Fdstat, Errno> {
    ...
    let ret = wasix_64v1::fd_fdstat_get(fd as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn fd_fdstat_set_flags(fd: Fd, flags: Fdflags) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_fdstat_set_flags(fd as i32, flags as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_fdstat_set_rights(
    ...
    let ret = wasix_64v1::fd_fdstat_set_rights(
        fd as i32,
...
pub unsafe fn fd_filestat_get(fd: Fd) -> Result<Filestat, Errno> {
    ...
    let ret = wasix_64v1::fd_filestat_get(fd as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn fd_filestat_set_size(fd: Fd, size: Filesize) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_filestat_set_size(fd as i32, size as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_filestat_set_times(
    ...
    let ret =
        wasix_64v1::fd_filestat_set_times(fd as i32, atim as i64, mtim as i64, fst_flags as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_prestat_get(fd: Fd) -> Result<Prestat, Errno> {
    ...
    let ret = wasix_64v1::fd_prestat_get(fd as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn fd_prestat_dir_name(
    ...
    let ret = wasix_64v1::fd_prestat_dir_name(fd as i32, path as i64, path_len as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_renumber(fd: Fd, to: Fd) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_renumber(fd as i32, to as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_seek(fd: Fd, offset: Filedelta, whence: Whence) -> Result<Filesize, Errno> {
    ...
    let ret = wasix_64v1::fd_seek(fd as i32, offset, whence.0 as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn fd_sync(fd: Fd) -> Result<(), Errno> {
    let ret = wasix_64v1::fd_sync(fd as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn fd_tell(fd: Fd) -> Result<Filesize, Errno> {
    let mut rp0 = MaybeUninit::<Filesize>::uninit();
    let ret = wasix_64v1::fd_tell(fd as i32, rp0.as_mut_ptr() as i64);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i64 as *const Filesize)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn pipe() -> Result<(Fd, Fd), Errno> {
    ...
    let ret = wasix_64v1::pipe(rp0.as_mut_ptr() as i64, rp1.as_mut_ptr() as i64);
    match ret {
        0 => Ok((
...
pub unsafe fn path_create_directory(fd: Fd, path: &str) -> Result<(), Errno> {
    let ret = wasix_64v1::path_create_directory(fd as i32, path.as_ptr() as i64, path.len() as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn path_filestat_get(fd: Fd, flags: Lookupflags, path: &str) -> Result<Filestat, Errno> {
    let mut rp0 = MaybeUninit::<Filestat>::uninit();
    let ret = wasix_64v1::path_filestat_get(
        fd as i32,
        flags as i32,
        path.as_ptr() as i64,
        path.len() as i64,
...
pub unsafe fn path_filestat_set_times(
    ...
    let ret = wasix_64v1::path_filestat_set_times(
        fd as i32,
        flags as i32,
        path.as_ptr() as i64,
        path.len() as i64,
...
pub unsafe fn path_readlink(
    ...
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = wasix_64v1::path_readlink(
        fd as i32,
        path.as_ptr() as i64,
        path.len() as i64,
        buf as i64,
...
pub unsafe fn path_remove_directory(fd: Fd, path: &str) -> Result<(), Errno> {
    let ret = wasix_64v1::path_remove_directory(fd as i32, path.as_ptr() as i64, path.len() as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn path_rename(fd: Fd, old_path: &str, new_fd: Fd, new_path: &str) -> Result<(), Errno> {
    let ret = wasix_64v1::path_rename(
        fd as i32,
        old_path.as_ptr() as i64,
        old_path.len() as i64,
        new_fd as i32,
...
pub unsafe fn path_symlink(old_path: &str, fd: Fd, new_path: &str) -> Result<(), Errno> {
    let ret = wasix_64v1::path_symlink(
        old_path.as_ptr() as i64,
        old_path.len() as i64,
        fd as i32,
        new_path.as_ptr() as i64,
...
pub unsafe fn path_unlink_file(fd: Fd, path: &str) -> Result<(), Errno> {
    let ret = wasix_64v1::path_unlink_file(fd as i32, path.as_ptr() as i64, path.len() as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn poll_oneoff(
    ...
    let mut rp0 = MaybeUninit::<Size>::uninit();
    let ret = wasix_64v1::poll_oneoff(
        in_ as i64,
        out as i64,
...
pub unsafe fn proc_exit(rval: Exitcode) {
    wasix_64v1::proc_exit(rval as i32);
}
...
pub unsafe fn proc_raise(sig: Signal) -> Result<(), Errno> {
    let ret = wasix_64v1::proc_raise(sig.0 as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sched_yield() -> Result<(), Errno> {
    let ret = wasix_64v1::sched_yield();
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn random_get(buf: *mut u8, buf_len: Pointersize) -> Result<(), Errno> {
    let ret = wasix_64v1::random_get(buf as i64, buf_len as i64);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn thread_spawn(user_data: u64, stack_base: u64, reactor: Bool) -> Result<Tid, Errno> {
    ...
    let ret = wasix_64v1::thread_spawn(
        user_data as i64,
        stack_base as i64,
        reactor.0 as i32,
        rp0.as_mut_ptr() as i64,
...
pub unsafe fn getpid() -> Result<Pid, Errno> {
    ...
    let ret = wasix_64v1::getpid(rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn getppid(pid: Pid) -> Result<Pid, Errno> {
    let mut rp0 = MaybeUninit::<Pid>::uninit();
    let ret = wasix_64v1::getppid(pid as i32, rp0.as_mut_ptr() as i64);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i64 as *const Pid)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn stack_save(snapshot: *mut StackSnapshot, persist: Bool, val: Longsize) -> Longsize {
    let ret = wasix_64v1::stack_save(snapshot as i64, persist.0 as i32, val as i64);
    ret as u64
}
...
pub unsafe fn stack_forget(snapshot: *const StackSnapshot) {
    wasix_64v1::stack_forget(snapshot as i64);
}
...
pub unsafe fn fork() -> Result<Pid, Errno> {
    let mut rp0 = MaybeUninit::<Pid>::uninit();
    let ret = wasix_64v1::fork(rp0.as_mut_ptr() as i64);
    match ret {
        0 => Ok(core::ptr::read(rp0.as_mut_ptr() as i64 as *const Pid)),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn bus_close(bid: Bid) -> Result<(), BusError> {
    let ret = wasix_64v1::bus_close(bid as i32);
    match ret {
        0 => Ok(()),
        _ => Err(BusError(ret as u32)),
    }
...
pub unsafe fn http_status(fd: Fd, status: *mut HttpStatus) {
    wasix_64v1::http_status(fd as i32, status as i64);
}
...
pub unsafe fn sock_shutdown(fd: Fd, how: Sdflags) -> Result<(), Errno> {
    let ret = wasix_64v1::sock_shutdown(fd as i32, how as i32);
    match ret {
        0 => Ok(()),
        _ => Err(Errno(ret as u16)),
    }
...
pub unsafe fn sock_accept(fd: Fd, flags: Fdflags) -> Result<(Fd, AddrPort), Errno> {
    ...
    let ret = wasix_64v1::sock_accept(
        fd as i32,
        flags as i32,
        rp0.as_mut_ptr() as i64,
...
pub mod wasix_64v1 {
    ...
    extern "C" {
        ...
        /// memory address space, file handles and main event loops.
        /// The web assembly process must export function named '_start_thread'
        pub fn thread_spawn(arg0: i64, arg1: i64, arg2: i32, arg3: i64) -> i32;
        /// Sends the current thread to sleep for a period of time
        ...
        /// in order for the trampoline to work properly.
        /// This function will manipulate the __stackpointer
        pub fn stack_save(arg0: i64, arg1: i32, arg2: i64) -> i64;
        /// Restores the current stack to a previous stack described by its
        /// stack hash.
        /// This function signature must exactly match the `stack_save` function
        /// in order for the trampoline to work properly.
        ...
        /// Retrieves the status of a HTTP request
        pub fn http_status(arg0: i32, arg1: i64);
        /// Securely connects to a particular remote network
