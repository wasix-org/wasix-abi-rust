...
pub unsafe fn fd_isatty(fd: Fd) -> Result<Bool, Errno> {
    ...
    let ret = wasix_64v1::fd_isatty(fd as i32, rp0.as_mut_ptr() as i64);
    match ret {
...
pub unsafe fn callback_thread(callback: &str) {
    wasix_64v1::callback_thread(callback.as_ptr() as i64, callback.len() as i64);
}
...
pub unsafe fn callback_reactor(callback: &str) {
    wasix_64v1::callback_reactor(callback.as_ptr() as i64, callback.len() as i64);
}
...
pub unsafe fn callback_thread_local_destroy(callback: &str) {
    wasix_64v1::callback_thread_local_destroy(callback.as_ptr() as i64, callback.len() as i64);
}
...
pub mod wasix_64v1 {
    ...
    extern "C" {
        ...
        /// Returns true if the file descriptor is a TTY
        pub fn fd_isatty(arg0: i32, arg1: i64) -> i32;
        /// Synchronize the data of a file to disk.
        /// Note: This is similar to `fdatasync` in POSIX.
        ...
        /// Registers a callback function for new threads
        pub fn callback_thread(arg0: i64, arg1: i64);
        /// Registers a callback function for reactors
        pub fn callback_reactor(arg0: i64, arg1: i64);
        /// Registers a callback function for destruction of thread locals
        pub fn callback_thread_local_destroy(arg0: i64, arg1: i64);
        /// Creates a new thread by spawning that shares the same
        /// memory address space, file handles and main event loops.
        /// The web assembly process must export function named '_start_thread'
